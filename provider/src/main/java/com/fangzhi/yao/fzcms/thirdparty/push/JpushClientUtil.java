...
public class JpushClientUtil {
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAlias(String appKey, String masterSecret, String alias,String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
     ...
     * @return 0推送失败，1推送成功
     */
    public static int sendToAll(String appKey, String masterSecret, String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
